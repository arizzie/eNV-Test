...
namespace Data
{
    public class EvnContext : DbContext
    {
        ...
        public DbSet<AdditionalVehicleInfo> AdditionalVehicleInfo { get; set; }
        public DbSet<VehicleVariable> VehicleVariables { get; set; }

        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {

            // Configure the relationship between Car and AdditionalCarInfo
            // Primary key for AdditionalCarInfo is a composite key of VariableId, CarId, and Value.
            ...
            modelBuilder.Entity<AdditionalVehicleInfo>()
                .HasKey(aci => new { aci.VariableId, aci.CarId, aci.Value });

            modelBuilder.Entity<AdditionalVehicleInfo>()
                .HasOne(aci => aci.Car)
                .WithMany(c => c.AdditionalVehicleInfo)
                .HasForeignKey(aci => aci.CarId);
